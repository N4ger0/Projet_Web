...
class ProduitFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $produit1
            ...
            ->setPrixunit(15.99)
            ->setQuantity(2)
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'France']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Espagne']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Belgique']));
        ...
        $produit2
            ...
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'France']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Espagne']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Allemagne']));
        ...
        $produit3
            ...
            ->setQuantity(1)
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'France']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Grèce']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Italie']));
        ...
        $produit5
            ...
            ->setPrixunit(15.00)
            ->setQuantity(7)
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Finlande']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Irlande']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Belgique']));
        ...
        $produit7
            ...
            ->setPrixunit(15.60)
            ->setQuantity(4)
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Pologne']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Espagne']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Portugal']));
        ...
        $produit9
            ...
            ->setPrixunit(10.00)
            ->setQuantity(6)
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Danemark']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Espagne']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Finlande']));
        ...
        $produit11
            ...
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'France']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Portugal']))
            ->addPay($manager->getRepository( Pays::class)->findOneBy(['name' => 'Suède']));
